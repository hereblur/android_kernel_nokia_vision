...
/* Modify by ye_qin for usb eye pattern 20220622 */
#define USB20_TUNEHSAMP_EYE_PATTERN	0x1af04301
...
static int sprd_hsphy_init(struct usb_phy *x)
{
	...
	/* Modify by ye_qin for usb eye pattern 20220622 begin */
	reg = USB20_TUNEHSAMP_EYE_PATTERN;
	msk = 0xffffffff;
	/* Modify by ye_qin for usb eye pattern 20220622 end */
	regmap_update_bits(phy->ana_g4,
